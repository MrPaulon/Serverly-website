...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex flex-col text-indigo-100 relative" }, _attrs))} data-v-a4557ff2><nav style="${ssrRenderStyle({ "background-color": "rgb(30 38 53 / 80%)", "backdrop-filter": "blur(10px)" })}" class="fixed top-6 left-1/2 transform -translate-x-1/2 w-11/12 max-w-4xl bg-opacity-80 backdrop-blur-md rounded-2xl px-4 py-3 flex items-center justify-between shadow-lg z-50 md:px-8" data-v-a4557ff2><div class="flex items-center space-x-3" data-v-a4557ff2><img${ssrRenderAttr("src", _imports_0)} alt="Logo" class="h-10 w-10 object-contain" data-v-a4557ff2><span class="text-indigo-200 font-semibold text-xl select-none" data-v-a4557ff2>Serverly</span></div><div class="hidden md:flex flex-row items-center space-x-4 text-indigo-300 font-medium" data-v-a4557ff2>`);
      ...
      _push(`</div><button class="block md:hidden text-indigo-300 focus:outline-none" aria-label="Toggle menu" data-v-a4557ff2><svg class="h-8 w-8" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" data-v-a4557ff2>`);
      if (!isMenuOpen.value) {
        _push(`<path d="M4 6h16M4 12h16M4 18h16" data-v-a4557ff2></path>`);
      } else {
        _push(`<path d="M6 18L18 6M6 6l12 12" data-v-a4557ff2></path>`);
      }
      _push(`</svg></button></nav>`);
      if (isMenuOpen.value) {
        _push(`<div style="${ssrRenderStyle({ "background-color": "var(--color-background)" })}" class="fixed top-0 left-0 w-full h-screen bg-opacity-95 backdrop-blur-md z-40 flex flex-col items-center justify-center space-y-8 text-indigo-100 text-xl font-semibold" data-v-a4557ff2>`);
        _push(ssrRenderComponent(_component_UButton, {
          icon: "solar:document-bold-duotone",
          size: "xl",
          color: "primary",
      ...
      _push(`<section style="${ssrRenderStyle({ "background-color": "var(--color-background)" })}" class="py-30 px-6 text-center hero-texture" data-v-a4557ff2><div class="blur-bg" data-v-a4557ff2></div><div class="max-w-3xl mx-auto" data-v-a4557ff2><h1 class="text-4xl md:text-5xl pt-20 font-bold mb-6 text-indigo-300" data-v-a4557ff2> G\xE9rez vos serveurs simplement. </h1><p class="text-lg md:text-xl mb-8 text-indigo-200" data-v-a4557ff2> Une interface moderne pour monitorer, contr\xF4ler et automatiser vos serveurs. </p>`);
      _push(ssrRenderComponent(_component_UButton, {
      ...
      _push(`</div></section><section style="${ssrRenderStyle({ "background-color": "var(--color-background)" })}" class="py-16 px-6" data-v-a4557ff2><div class="max-w-6xl mx-auto grid md:grid-cols-3 gap-10" data-v-a4557ff2><div style="${ssrRenderStyle({ "background-color": "var(--color-surface)" })}" class="rounded-xl p-12 shadow-lg text-center feature-texture" data-v-a4557ff2><div class="mb-4" data-v-a4557ff2>`);
      _push(ssrRenderComponent(_component_UIcon, {
        style: { "width": "40px", "height": "40px", "color": "var(--color-primary)" },
        name: "solar:eye-bold-duotone",
        class: "size-12"
      }, null, _parent));
      _push(`</div><h3 class="text-xl font-semibold mb-2 text-indigo-200" data-v-a4557ff2>Surveillance en temps r\xE9el</h3><p class="text-gray-400" data-v-a4557ff2>Visualisez l&#39;\xE9tat de vos serveurs instantan\xE9ment.</p></div><div style="${ssrRenderStyle({ "background-color": "var(--color-surface)" })}" class="rounded-xl p-12 shadow-lg text-center feature-texture" data-v-a4557ff2><div class="mb-4" data-v-a4557ff2>`);
      _push(ssrRenderComponent(_component_UIcon, {
        style: { "width": "40px", "height": "40px", "color": "var(--color-primary)" },
        name: "solar:code-square-bold-duotone",
        class: "size-12"
      }, null, _parent));
      _push(`</div><h3 class="text-xl font-semibold mb-2 text-indigo-200" data-v-a4557ff2>Automatisations</h3><p class="text-gray-400" data-v-a4557ff2>D\xE9clenchez des actions automatiquement selon vos r\xE8gles.</p></div><div style="${ssrRenderStyle({ "background-color": "var(--color-surface)" })}" class="rounded-xl p-12 shadow-lg text-center feature-texture" data-v-a4557ff2><div class="mb-4" data-v-a4557ff2>`);
      _push(ssrRenderComponent(_component_UIcon, {
        style: { "width": "40px", "height": "40px", "color": "var(--color-primary)" },
        name: "solar:monitor-bold-duotone",
        class: "size-12"
      }, null, _parent));
      _push(`</div><h3 class="text-xl font-semibold mb-2 text-indigo-200" data-v-a4557ff2>Tableau de bord intuitif</h3><p class="text-gray-400" data-v-a4557ff2>Une UI claire, pens\xE9e pour les admins.</p></div></div></section><section style="${ssrRenderStyle({ "background-color": "var(--color-background)" })}" class="py-16 px-6 text-center max-w-4xl mx-auto" data-v-a4557ff2><h2 class="text-3xl font-bold text-indigo-300 mb-6" data-v-a4557ff2>Pourquoi choisir Serverly ?</h2><p class="text-indigo-200 text-lg leading-relaxed" data-v-a4557ff2> Serverly vous offre une plateforme intuitive et puissante pour g\xE9rer vos serveurs avec facilit\xE9. Profitez d\u2019une surveillance en temps r\xE9el, d\u2019automatisations avanc\xE9es, et d\u2019un tableau de bord pens\xE9 pour les administrateurs. </p></section><section style="${ssrRenderStyle({ "background-color": "var(--color-background)", "display": "flex", "justify-content": "center" })}" class="py-16 px-6 gallery-texture" data-v-a4557ff2>`);
      _push(ssrRenderComponent(_component_UCarousel, {
        ...
        default: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", item)} width="450" height="300" class="rounded-lg cursor-pointer" alt="Aper\xE7u serveur" data-v-a4557ff2${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: item,
      ...
      if (selectedImage.value) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 cursor-pointer" data-v-a4557ff2><img${ssrRenderAttr("src", selectedImage.value)} alt="Image agrandie" class="max-w-4xl max-h-[90vh] rounded-lg shadow-lg" data-v-a4557ff2><button aria-label="Fermer" class="absolute top-6 right-6 text-white bg-gray-900 bg-opacity-60 rounded-full p-2 hover:bg-opacity-80" data-v-a4557ff2> \u2715 </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<section class="py-20 px-6 text-center gallery-texture text-indigo-100" data-v-a4557ff2><div class="max-w-3xl mx-auto flex flex-col items-center gap-6" data-v-a4557ff2><img${ssrRenderAttr("src", _imports_0)} alt="Serverly Logo" class="w-40 h-40 object-contain" data-v-a4557ff2><h2 class="text-3xl font-bold" data-v-a4557ff2>The Future of Easy Hosting</h2>`);
      _push(ssrRenderComponent(_component_UButton, {
        to: "/",
        size: "lg",
        color: "primary",
      ...
      _push(`</div></section><footer style="${ssrRenderStyle({ "background-color": "var(--color-surface)", "color": "var(--color-text)", "font-weight": "bold" })}" class="py-6 text-center text-sm mt-auto" data-v-a4557ff2> \xA9 2025 - Serverly. Tous droits r\xE9serv\xE9s. </footer></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a4557ff2"]]);

export { index as default };
//# sourceMappingURL=index-DqrZRlrF.mjs.map
